...
const posts = [
  { date: "May 2026", tag: "Crop Science", title: "How AI-Powered Irrigation Reduced Water Usage by 40%", excerpt: "A deep dive into how precise soil-moisture thresholds and automated pump control cut consumption on a tomato greenhouse in southern Algeria." },
  { date: "April 2026", tag: "Case Study", title: "From Paper Logs to Real-Time Dashboards: One Farmer's Journey", excerpt: "Hamid, a wheat farmer from Blida, shares how SahlaFarm replaced his weekly manual log with a live sensor feed." },
  { date: "March 2026", tag: "Tech", title: "Edge Computing in Agriculture: Why Local Matters", excerpt: "Internet outages shouldn't stop your farm. We explain how SahlaFarm's Raspberry Pi setup keeps you monitored even offline." },
  { date: "Feb 2026", tag: "Product Update", title: "New: Historical Charts & 7-Day Sensor Trends", excerpt: "Compare this week's humidity levels with last week's. The new analytics view gives you a full picture of your farm over time." },
  { date: "Jan 2026", tag: "Guide", title: "Choosing the Right Growth Stage in SahlaFarm", excerpt: "Your growth stage setting shapes every AI recommendation. Here's how to pick the right one and when to update it." },
  { date: "Dec 2025", tag: "Sustainability", title: "Smart Farming's Role in Algeria's Food Security Future", excerpt: "With climate volatility rising, data-driven agriculture is no longer optional — it's essential." },
];
      ...
      <section style={{ background: "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(85,187,51,0.15) 0%, transparent 70%)", padding: "80px 24px 60px", textAlign: "center" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(25,37,20,0.6)", lineHeight: 1.8 }}>
            Practical guides, case studies, and product news — everything you need to grow with confidence.
          </p>
        </div>
      </section>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(320px,1fr))", gap: 28 }}>
          {posts.map((p) => (
            <article key={p.title} style={{ background: "#fff", borderRadius: 20, padding: 28, border: "1px solid rgba(25,37,20,0.07)", boxShadow: "0 4px 20px rgba(0,0,0,0.04)", display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <h2 style={{ fontSize: 17, fontWeight: 700, color: "#192514", lineHeight: 1.4, margin: 0 }}>{p.title}</h2>
              <p style={{ fontSize: 14, color: "rgba(25,37,20,0.6)", lineHeight: 1.7, margin: 0, flex: 1 }}>{p.excerpt}</p>
              <a href="#" style={{ fontSize: 13, fontWeight: 600, color: "#55BB33", textDecoration: "none" }}>Read more →</a>
            </article>
          ))}
        </div>
      </section>
