    ...
    <div style={{ fontFamily: "Poppins, sans-serif", background: "#F5F7F2", minHeight: "100vh" }} dir={isArabic ? "rtl" : "ltr"}>
      ...
      <section style={{ background: "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(85,187,51,0.15) 0%, transparent 70%)", padding: "80px 24px 60px", textAlign: "center" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(25,37,20,0.6)", lineHeight: 1.8 }}>
            Last updated: May 2026 · By using SahlaFarm you agree to these terms.
          </p>
        </div>
      </section>
      ...
      <main style={{ maxWidth: 780, margin: "0 auto", padding: "60px 24px 100px" }}>
        <Section title="1. Acceptance of Terms">
          <p>By accessing or using SahlaFarm ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.</p>
        </Section>

        <Section title="2. Account Responsibilities">
          <p>You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. Notify us immediately at <strong>contact@sahlafarm.com</strong> if you suspect unauthorised access.</p>
        </Section>

        <Section title="3. Acceptable Use">
          <p>You agree not to: (a) reverse-engineer the SahlaFarm platform; (b) use the Service for any unlawful purpose; (c) transmit malware or disruptive code through the system; (d) resell or redistribute access without written permission.</p>
        </Section>

        <Section title="4. Sensor Data & Hardware">
          <p>SahlaFarm is designed for use with compatible IoT hardware (Raspberry Pi + SahlaFarm sensors). You are responsible for the correct installation, maintenance, and power supply of your hardware. SahlaFarm is not liable for crop losses arising from hardware failure or incorrect configuration.</p>
        </Section>

        <Section title="5. Service Availability">
          <p>We aim for 99.5% monthly uptime but do not guarantee uninterrupted availability. Planned maintenance windows will be communicated via email at least 24 hours in advance. Local edge computing means your dashboard may remain partially functional during outages.</p>
        </Section>

        <Section title="6. Intellectual Property">
          <p>All software, designs, trademarks, and content within SahlaFarm remain the exclusive property of SahlaFarm and its licensors. Your farm data remains yours — we claim no ownership over it.</p>
        </Section>

        <Section title="7. Limitation of Liability">
          <p>SahlaFarm is provided "as is." To the maximum extent permitted by applicable law, SahlaFarm shall not be liable for indirect, incidental, or consequential damages arising from use of the Service.</p>
        </Section>

        <Section title="8. Governing Law">
          <p>These Terms are governed by the laws of Algeria. Any disputes shall first be submitted to good-faith mediation before any formal legal proceedings.</p>
        </Section>

        <Section title="9. Changes">
          <p>We may update these Terms at any time. Material changes will be communicated by email. Continued use after the effective date constitutes your acceptance of the updated Terms.</p>
        </Section>

        <Section title="10. Contact">
          <p>Questions about these Terms? Contact us at <strong>contact@sahlafarm.com</strong>.</p>
        </Section>
      </main>

      {/* Footer */}
      <footer style={{ background: "#192514", padding: "24px", textAlign: "center" }}>
        <p style={{ color: "rgba(245,247,242,0.4)", fontSize: 13, margin: 0 }}>© 2026 SahlaFarm · <Link to="/privacy" style={{ color: "rgba(85,187,51,0.8)", textDecoration: "none" }}>Privacy</Link> · <Link to="/" style={{ color: "rgba(85,187,51,0.8)", textDecoration: "none" }}>Home</Link></p>
      </footer>
    </div>
  );
}
